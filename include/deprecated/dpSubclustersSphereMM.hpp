...
public:
   ...
   // cluster parameters
   niwSphere_sampled hyper;
   vector< cluster_sampledT<niwSphere_sampled>* > params;
...
public:
   ...
   DpSubclustersSphereMM();
   // --------------------------------------------------------------------------
   // --   copy constructor;
   DpSubclustersSphereMM(const DpSubclustersSphereMM& that);
   // --------------------------------------------------------------------------
   // --   assignment operator
   DpSubclustersSphereMM& operator=(const DpSubclustersSphereMM& that);
   // --------------------------------------------------------------------------
   // --   returns a copy of this
   void copy(const DpSubclustersSphereMM& that);
   // --------------------------------------------------------------------------
   // --   constructor; intializes to all the values given
   DpSubclustersSphereMM(int _N, int _D, double* _data, double* _phi,
            double _alpha, niwSphere_sampled &_hyper, int _Nthreads,
            bool _useSuperclusters, bool _always_splittable);

   // --------------------------------------------------------------------------
   virtual ~DpSubclustersSphereMM();
...
inline int DpSubclustersSphereMM::getK() const
{
   return alive.getLength();
}
inline int DpSubclustersSphereMM::getNK() const
{
   int maxNK = 0;
